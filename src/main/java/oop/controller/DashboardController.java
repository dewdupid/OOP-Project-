package oop.controller; // Structure
...
public class DashboardController implements Initializable {
    ...
    private ObservableList<Product> productList; // store all product (ArrayList)
    ...
    public void setSessionUser(String username) {
        ...
        this.currentFilePath = "src/inventory/" + currentUserSession + "_inventory.txt";
        productList.clear();
    ...
    private void openManagementWindow() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/oop/Transaction.fxml"));
            javafx.scene.Parent root = loader.load();
            TransactionController controller = loader.getController(); //get controller
    ...
    public void loadInventoryFromFile() {
        ...
        // If the file is completely empty or just newly generated by LoginController, seed it!
        if (!file.exists() || file.length() == 0) {
            System.out.println("No existing inventory payload found. Seeding personal file...");
            createSampleFile();
            return;
        }

        System.out.println("User file found! Synchronizing personal inventory...");
    ...
    private void createSampleFile() {
        productList.clear(); // Clear current active memory tracking to prevent duplicates
        ...
        saveInventoryToFile(); // Commit modifications instantly to the file structure
    }
    ...
    private void handleBackToLogin() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/oop/Login.fxml"));
            javafx.scene.Parent root = loader.load();
    ...
    public void sampleProduct(String ID, String name, String category, int quantity, double price) {
        Product product = Product.create(ID, name, category, quantity, price);
        ...
        public void updDb () {
            ...
            // 2. Update new sidebar insight values
